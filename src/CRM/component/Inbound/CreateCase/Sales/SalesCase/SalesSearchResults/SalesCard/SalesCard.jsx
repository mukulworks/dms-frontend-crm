...
import {  fillCallerInformation } from '../../../../../../../store/actions/inboundActions'

const SalesCard = ({ id, listData, isActive, isCaseDataSheetActive, setIsCaseDataSheetActive, setCaseDataSheetApiReqData }) => {
                                    ...
                                    <div className="card-header">
                                        <div className="custom-radio-btn">
                                            ...
                                            >
                                                ...
                                                />
                                                <label className="custom-control-label text-primary" htmlFor={id + "-" + key} onClick={() => handleClick(item.dataType === 'CASE_MASTER_SERIAL' ? item.caseUniqueId : item.custMasterSerial)}>
                                                    {item.displayId}
                                                </label>
                                            </div>
                                            <a 
                                                ...
                                                onClick={() => handleDotClick(item.caseUniqueId)}
                                            >
