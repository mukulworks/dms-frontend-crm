...
export const updateCreateNewCaseUploadedDocumentBalanceCountSize = (
  payload
) => {
  return {
...
export const updateManageFollowUpUploadedDocumentBalanceCountSize = (
  payload
) => {
  return {
...
//edit by mukul
export const selectedVinNumber = (payload) => {
  return {
    type: types.SELECTED_VIN_NUMBER,
    payload,
  };
};

export const resetSelectedVinNumber = (payload) => {
  return {
    type: types.RESET_SELECTED_VIN_NUMBER,
    payload,
  };
};
